...
function worldClockZone(){
	...
	document.getElementById("TKTIME").innerHTML = worldClock(9, "Tokyo")
	document.getElementById("NYTIME").innerHTML = worldClock(-5, "NAmerica")
	document.getElementById("LDTIME").innerHTML = worldClock(0, "Europe")
/**	
...
//setTimeout("worldClockZone()",30000);
