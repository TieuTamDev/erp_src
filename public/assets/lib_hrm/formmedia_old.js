        ...
        tableDom.innerHTML = `<table class="table table-bordered fs--2 table-sm mb-0">
                                    <thead class="text-900 bg-200">
                                        <tr>
                                            ...
                                            <th class="sort d-none" data-sort="file_owner">${this.#translate.status} <b style="color: red;">*</b></th>
                                ...
                                <div class="d-none form-check ${this.#bShowLabelAdd == true ? "" : "d-none"}" style="margin-left: 2px;">
        ...
        var options = {
            ...
            item: function (doc){
                ...
                return `<tr class="${doc.type}" id="item-${self.#containerID}${doc.id}">
                            ...
                            <td id="radio-group-td" style="text-align: left;vertical-align: middle;" class="check-box d-none">
